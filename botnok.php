...
$dbName = "botnok";
 ...
 $sql = mysqli_query($conn, "INSERT INTO note VALUES(NULL, $a[0],$a[1],$a[2],$a[3],$a[4],$a[5],$a[6])");
 ...
 $text = "add,1,2,3,4,5,6";
 $command1 = "add";
 $text_ar = explode(",",$text);
 $text_array0 = $text_ar[0];
...
if(!is_null($eventFollow)){
    ...
    $textReplyMessage = ' #### PN ALL ####                                               สวัสดีครับคุณ' .$userData['displayName'].'                          UID ของท่านคือ ' .$userId .  '                                                           หากสงสัยว่า ทำอะไรได้บ้าง                                               พิมพ์ help หรือ h ครับ                                       copyright by noksoft' ;     
     ...
     if(!is_null($eventMessage)){
         switch ($typeMessage){ // กำหนดเงื่อนไขการทำงานจาก ประเภทของ message
             case 'text':  // ถ้าเป็นข้อความ
                 ...
                 if ($text_ar[0]  == "add"){
                    $sql = mysqli_query($conn, "INSERT INTO note VALUES(NULL,'".$text_ar[1]."','".$text_ar[2]."','".$text_ar[3]."','".$text_ar[4]."','".$text_ar[5]."','".$text_ar[6]."','$userId')");
                    $textReplyMessage = "ทำการบันทึกเรียบร้อย\nเลขบันทึกที่:".$text_ar[1]."\nหัวข้อ:".$text_ar[2]."\nเนื้อหา:".$text_ar[3]."\nวันที่:".$text_ar[4]."\nเวลา:".$text_ar[5]."\nสถานที่:".$text_ar[6]."                       ผู้บันทึก".$userId;   
                    $replyData = new TextMessageBuilder($textReplyMessage); 
